...
namespace MOVIE_BOOKING_CORE.Migrations
{
    ...
    [Migration("20211109150351_User_Bookings_Relationship")]
    partial class User_Bookings_Relationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOVIE_BOOKING_CORE.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("MOVIE_BOOKING_CORE.Models.MovieBooking", b =>
                {
                    b.HasOne("MOVIE_BOOKING_CORE.Models.AppUser", "AppUser")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MOVIE_BOOKING_CORE.Models.AppUser", null)
                        .WithMany()
